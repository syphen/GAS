 ...
 */
var gas$=jQuery.noConflict(true);
var GAS=function(g){
	this.options=new Object();
	this.init=function(a){
		if(typeof a == 'object'){
			this.options.uacode=(a.uacode!=undefined)?a.uacode:"";
	...
	this.run=function(){
		...
		gas$(document).ready(function(){
			...
			try{
				f=_gat._getTracker(myGAS.options.uacode);
